 ...
 *
 * <p>Intervals are inclusive of the start and exclusive of the end.
 */
@Value
...
public class LocalDateTimeInterval {
  ...
  /**
   * Obtains an instance of {@code DateTimeInterval} from a text string such as {@code
   * 2007-12-03T10:15:30}.
   *
   * <p>The string must represent a valid interval and is parsed using {@link
