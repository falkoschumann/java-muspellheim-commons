    ...
    static Stream<Arguments> compareWithOtherProvider() {
        ...
        return Stream.of(
            arguments("interval is equal other ",
                ...
                true, false, false, true, false, null, true, Interval.of(start, end)),
            arguments("interval is after other",
                interval, Interval.of(before1, before2),
                false, false, true, false, false, Interval.of(before2, start), false, null),
            arguments("intervals start abuts others end",
                interval, Interval.of(before2, start),
                false, false, true, false, true, null, false, null),
            arguments("interval start overlaps other",
                interval, Interval.of(before1, within2),
                false, false, false, false, false, null, true, Interval.of(start, within2)
            ),
            arguments("intervals start abuts others start",
                interval, Interval.of(start, within1),
                false, false, false, true, false, null, true, Interval.of(start, within1)
            ),
            arguments("interval contains other",
                interval, Interval.of(within1, within2),
                false, false, false, true, false, null, true, Interval.of(within1, within2)
            ),
            arguments("intervals end abuts others end",
                interval, Interval.of(within1, end),
                false, false, false, true, false, null, true, Interval.of(within1, end)
            ),
            arguments("intervals end overlaps other",
                interval, Interval.of(within2, after1),
                false, false, false, false, false, null, true, Interval.of(within2, end)
            ),
            arguments("intervals end abuts others start",
                interval, Interval.of(end, after1),
                false, true, false, false, true, null, false, null
            ),
            arguments("interval is before other",
                interval, Interval.of(after1, after2),
                false, true, false, false, false, Interval.of(end, after1), false, null
            )
        );
    }
