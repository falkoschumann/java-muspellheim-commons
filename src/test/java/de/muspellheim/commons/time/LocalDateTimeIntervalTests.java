...
class LocalDateTimeIntervalTests {
  ...
  void createInvalid() {
    ...
    assertThrows(
        ...
        () -> LocalDateTimeInterval.of(end, start),
        "start after end");
  }
  ...
  static Stream<Arguments> compareWithOtherProvider() {
    ...
    return Stream.of(
        arguments(
            ...
            interval,
            LocalDateTimeInterval.of(start, end),
            true,
            false,
            false,
            true,
        ...
        arguments(
            ...
            interval,
            LocalDateTimeInterval.of(before1, before2),
            false,
            false,
            true,
            false,
            false,
            LocalDateTimeInterval.of(before2, start),
            false,
            null),
        arguments(
        ...
        arguments(
            ...
            interval,
            LocalDateTimeInterval.of(before1, within2),
            false,
            false,
            false,
            false,
            ...
            null,
            true,
            LocalDateTimeInterval.of(start, within2)),
        arguments(
            "intervals start abuts others start",
            interval,
            LocalDateTimeInterval.of(start, within1),
            false,
            false,
            false,
            true,
        ...
        arguments(
            ...
            interval,
            LocalDateTimeInterval.of(within1, within2),
            false,
            false,
            false,
            true,
        ...
        arguments(
            ...
            interval,
            LocalDateTimeInterval.of(within1, end),
            false,
            false,
            false,
            true,
        ...
        arguments(
            ...
            interval,
            LocalDateTimeInterval.of(within2, after1),
            false,
            false,
            false,
            false,
            ...
            null,
            true,
            LocalDateTimeInterval.of(within2, end)),
        arguments(
            "intervals end abuts others start",
            interval,
            LocalDateTimeInterval.of(end, after1),
            false,
            true,
            false,
            false,
        ...
        arguments(
            ...
            interval,
            LocalDateTimeInterval.of(after1, after2),
            false,
            true,
            false,
            false,
