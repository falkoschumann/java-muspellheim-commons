...
abstract class BaseResultSetMapperTests {
    ...
    static final ExampleEntity ENTITY_1 = new ExampleEntity("Foo", 42, 74.7, true, LocalDateTime.of(2000, 12, 31, 23, 59));
    static final ExampleEntity ENTITY_2 = new ExampleEntity("Bar", 24, 47.4, false, LocalDateTime.of(1999, 8, 2, 12, 0));
    ...
    void noMapper() {
        // When
        Throwable exception = assertThrows(NoSuchElementException.class, () -> new ConstructorResultSetMapper<>(BrokenEntity.class));
